...
const translations = {
  nb: {
    ...
    'projects.kvasi.desc': 'AI-drevet språklæring med repetisjonssystem. Beskriv hva du vil lære, og AI-en bygger øvelsene for deg.',
    ...
    'projectsPage.kvasi.desc': 'AI-drevet språklæringsplattform med repetisjonssystem. Fortell AI-en hva du vil lære via Hub-chatten — den genererer øvelser, evaluerer svarene dine med grammatikk-tilbakemeldinger, og tilpasser seg nivået ditt. Støtter 91 språk med CEFR-nivåsporing.',
    'projectsPage.category.language': 'Språklæring',
    'projectsPage.tag.spacedRep': 'Repetisjon',
  ...
  en: {
    ...
    'projects.kvasi.desc': 'AI-powered language learning with spaced repetition. Describe what you want to learn, and the AI builds your exercises.',
    ...
    'projectsPage.category.ai': 'AI',
    'projectsPage.category.app': 'App',
    'projectsPage.kvasi.desc': 'AI-powered language learning platform with spaced repetition. Tell the AI what you want to learn through the Hub chat — it generates exercises, evaluates your answers with grammar feedback, and adapts to your level. Supports 91 languages with CEFR level tracking.',
    'projectsPage.category.language': 'Language Learning',
    'projectsPage.tag.spacedRep': 'Spaced Repetition',
